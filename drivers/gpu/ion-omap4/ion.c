...
EXPORT_SYMBOL_GPL(ion_handle_phys);
...
EXPORT_SYMBOL_GPL(ion_phys_frm_dev);
...
EXPORT_SYMBOL_GPL(ion_map_kernel);
...
EXPORT_SYMBOL_GPL(ion_unmap_kernel);
...
EXPORT_SYMBOL_GPL(ion_unmap_dma);
...
EXPORT_SYMBOL_GPL(ion_import_fd);
...
EXPORT_SYMBOL_GPL(ion_client_create);
...
EXPORT_SYMBOL_GPL(ion_client_destroy);
